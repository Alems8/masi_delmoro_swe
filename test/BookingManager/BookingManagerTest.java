...
class BookingManagerTest {
    ...
    void releaseField() {
        ...
        bm.createBooking(userClub, gracciano.fields.get(0), LocalDate.parse("15/05/2022",
                        DateTimeFormatter.ofPattern("dd/MM/yyyy") ),15,players);
        bm.releaseField(1);

        assertTrue(gracciano.fields.get(0).timeTable.get(LocalDate.parse("15/05/2022",
    ...
    void addBookingPlayer() {
        bm.topUpUserBalance(mark,100);
        bm.topUpUserBalance(eli,100);
        bm.createBlindBooking(userClub, gracciano.fields.get(0), LocalDate.parse("15/05/2022",
    ...
    @Test
    void holdField(){
        bm.holdField(gracciano.fields.get(0), LocalDate.parse("15/05/2022",
                DateTimeFormatter.ofPattern("dd/MM/yyyy") ),15);

        assertFalse(gracciano.fields.get(0).timeTable.get(LocalDate.parse("15/05/2022",
                DateTimeFormatter.ofPattern("dd/MM/yyyy"))).contains(15));
    }
